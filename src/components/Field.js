    ...
    return (
        <>
            ...
            <RigidBody type="fixed">
                ...
                <Box position={[12, 2, 0]} args={[1, 8, fieldWidth]}><meshStandardMaterial visible={false} /></Box>
                <Box position={[-12, 2, 0]} args={[1, 8, fieldWidth]}><meshStandardMaterial visible={false} /></Box>
                ...
                */}
                ...
                {/* Vertical Walls */}
                <Box position={[0, 2, 12]} args={[fieldLength, 8, 1]}><meshStandardMaterial visible={false} /></Box>
                <Box position={[0, 2, -12]} args={[fieldLength, 8, 1]}><meshStandardMaterial visible={false} /></Box>
            </RigidBody>
